...
OutDir='OutDir'
ScriptDir='script'
Promoters='mm9.refseq.02_01_2017.4kbproms.bed.filtered'
WholeGenes='mm9.refseq.02_01_2017.wholegenes.bed.filtered'
INs='mES_INs_fromReview.nonProm.sorted.bed3'
Loops='HiChIP_mES_C3_UT_H3K27ac.Qvalue.0.01.H3K27ac_input_Peaks_1e-9.bed.mm9.refseq.02_01_2017.4kbproms.filtered.combined.5000.20000000.bedpe'
Enhancers='H3K27ac_input_Peaks_1e-9.mm10.bed'
EnSignal='03172010_614ATAAXX_B5_mm9.sorted.bam'
EnControl='02202009_313D1AAXX_B3_mm9.sorted.bam'
HighlightGenes='Irf2bpl|NM_145836,Suz12|NM_199196,Hist1h4h|NM_153173'
Network=0
OtherEnd=0
LO=0
PromIN=0
H3K27acPeaks='Res_H3K27ac-p9_kd-auto_peaks.bed'
H3K4me3Peaks='Res_H3K4me3-p9_kd-auto_peaks.bed'
CTCFPeaks='Res_CTCF_run-p9_kd-auto_peaks.bed'
H3K27me3Peaks='Res_H3K27me3-W200-G400-FDR0.01-island.bed'
ExpFile='mm10.expressed.gene.txt'
Seed=1
